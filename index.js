var bits = 300; // how many bits
var speed = 1; // how fast - smaller is faster
...
function launch(N) {
  ...
  Xpos[N + "r"] = swide * 0.5;
  Ypos[N + "r"] = shigh - 5;
  bangheight[N] = Math.round((0.2 + Math.random()) * shigh * 0.4);
...
document.addEventListener("click", function () {
  ...
  // Show the randomly selected picture

  pictures[randomIndex].style.display = "block";
});
